...
def attack(char_name: str, char_class: str) -> str:
    """Get the result of the training for applying damage."""
...
def defence(char_name: str, char_class: str) -> str:
    """Get the result of the training for applying defence."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Get the result of the training for applying special skill."""
    if char_class == 'warrior':
